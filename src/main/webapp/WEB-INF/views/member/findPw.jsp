    ...
    <div class="main-layout">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/findPw.jsp" class="active">비밀번호 찾기</a></li>
        ...
        <div class="login-box">
            <h2>비밀번호 찾기</h2>
            <form class="login-form" action="${pageContext.request.contextPath}/findPw.do" method="post">
