    ...
    <div class="main-layout">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="${pageContext.request.contextPath}/changePw.jsp" class="active">비밀번호 변경</a></li>
            </ul>
        </div>

        <div class="login-box">
            <h2>비밀번호 변경</h2>
            <form class="login-form" action="${pageContext.request.contextPath}/changePw.do" method="post">
                ...
                <input type="password" name="newPwConfirm" placeholder="새 비밀번호 확인" required>
