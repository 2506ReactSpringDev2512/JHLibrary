...
<body>
    ...
    <div class="main-layout">
        ...
        <div class="sidebar">
            <h3>대여/반납</h3>
            <ul>
                <li><a href="${pageContext.request.contextPath}/member/rentBook" class="active">대여도서 조회</a></li>
                <li><a href="${pageContext.request.contextPath}/member/returnBook">반납도서 조회</a></li>
            </ul>
        </div>
